      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            ...
            <div class="row mb-5">
              <div class="col-md-6">
                <figure><img src="Themes/img/img_1.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
                  <figcaption>This is an image caption</figcaption>
                </figure>
              </div>
              <div class="col-md-6">
                <figure><img src="Themes/img/img_2.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
                  <figcaption>This is an image caption</figcaption>
                </figure>
              </div>
            </div>
            ...
            <div class="pt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="Themes/img/person_1.jpg" alt="Free Website Template by Free-Template.co">
                  </div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="Themes/img/person_1.jpg" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>Jean Doe</h3>
                    <div class="meta">January 9, 2018 at 2:21pm</div>
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <img src="Themes/img/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
